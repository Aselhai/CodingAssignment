...
#
# The program is provided for your own studies only.
...
def newcolor():
     balls[k].fillcolor(random.randint(0, int(time.time()))*int(time.time())%256, random.randint(0, int(time.time()))*int(time.time())%256, random.randint(0, int(time.time()))*int(time.time())%256)
