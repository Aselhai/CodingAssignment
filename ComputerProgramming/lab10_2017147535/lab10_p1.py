...
def createModifiedFile(input_file, outputfile):
    ...
    for line in input_file:
        ...
        # remove all occurrances of letter 'a, e, i, o, u, A, E, I, O, U'
        modified_line = line.replace('a',empty_str).replace('A',empty_str).replace('e',empty_str).replace('E',empty_str).replace('i',empty_str).replace('I',empty_str).replace('o',empty_str).replace('O',empty_str).replace('u',empty_str).replace('U',empty_str)
